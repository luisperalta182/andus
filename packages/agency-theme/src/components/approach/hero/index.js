                ...
                <div className="heroImages approach">
                    <div className="heroMarquee"
                        ...
                        <Marquee direction="left" speed={0.2}>
                            APPROACH<span className="yellowText">*</span>AGENCY APPROACH<span className="yellowText">*</span>AGENCY APPROACH<span className="yellowText">*</span>AGENCY APPROACH<span className="yellowText">*</span>AGENCY APPROACH<span className="yellowText">*</span>AGENCY APPROACH<span className="yellowText">*</span>AGENCY 
                        </Marquee>
                    </div>
                </div>
            </Container>
