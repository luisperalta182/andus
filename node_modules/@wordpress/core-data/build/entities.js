...
exports.getMethodName = exports.prePersistPostType = exports.kinds = exports.defaultEntities = exports.DEFAULT_ENTITY_KEY = void 0;
...
function* loadPostTypeEntities() {
  const postTypes = yield (0, _dataControls.apiFetch)({
...
function* loadTaxonomyEntities() {
  const taxonomies = yield (0, _dataControls.apiFetch)({
...
function* getKindEntities(kind) {
  let entities = yield _data.controls.select(_name.STORE_NAME, 'getEntitiesByKind', kind);
  ...
  yield (0, _actions.addEntities)(entities);
  return entities;
}
