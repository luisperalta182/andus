...
function* loadPostTypeEntities() {
  const postTypes = yield apiFetch({
  ...
  return map(postTypes, (postType, name) => {
    ...
    return {
      ...
      getTitle: record => {
        ...
        return (record === null || record === void 0 ? void 0 : (_record$title = record.title) === null || _record$title === void 0 ? void 0 : _record$title.rendered) || (record === null || record === void 0 ? void 0 : record.title) || (isTemplate ? startCase(record.slug) : String(record.id));
      },
...
export function* getKindEntities(kind) {
  let entities = yield controls.select(STORE_NAME, 'getEntitiesByKind', kind);
