        ...
        case 'RECEIVE_ITEMS':
          ...
          for (const record of action.items) {
            ...
            const nextEdits = Object.keys(edits).reduce((acc, key) => {
              ...
              // comparison.
              !isEqual(edits[key], get(record[key], 'raw', record[key])) && ( // Sometimes the server alters the sent value which means
              // we need to also remove the edits before the api request.
              !action.persistedEdits || !isEqual(edits[key], action.persistedEdits[key]))) {
                acc[key] = edits[key];
              }
