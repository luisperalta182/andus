...
class ButtonEdit extends Component {
  ...
  render() {
    ...
    const borderRadiusValue = this.getBorderRadiusValue(borderRadius, styles.defaultButton.borderRadius);
...
export default compose([withInstanceId, withGradient, withSelect((select, {
  clientId,
  isSelected
}) => {
  const {
