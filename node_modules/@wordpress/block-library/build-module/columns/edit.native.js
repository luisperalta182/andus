...
const ColumnsEditContainerWrapper = withDispatch((dispatch, ownProps, registry) => ({
  ...
  updateColumns(previousColumns, newColumns) {
    ...
    if (isAddingColumn && hasExplicitWidths) {
      ...
      innerBlocks = [...getMappedColumnWidths(innerBlocks, widths), ...times(newColumns - previousColumns, () => {
      ...
      innerBlocks = [...innerBlocks, ...times(newColumns - previousColumns, () => {
        return createBlock('core/column', {
          verticalAlignment
        });
      })];
...
const ColumnsEdit = props => {
  ...
  const {
    ...
    const innerBlocks = getBlocks(clientId);
    const isContentEmpty = map(innerBlocks, innerBlock => innerBlock.innerBlocks.length);
