...
const EmbedPreview = ({
  ...
  'wp-embed' === type ? null : createElement(Fragment, null, createElement(TouchableWithoutFeedback, {
    onPress: () => {
      if (onFocus) {
        onFocus();
      }
  ...
  return createElement(TouchableWithoutFeedback, {
    ...
    disabled: !isSelected
  }, createElement(View, null, // eslint-disable-next-line no-undef
  __DEV__ && previewable ? embedWrapper : createElement(EmbedNoPreview, {
    label: label,
    icon: icon,
