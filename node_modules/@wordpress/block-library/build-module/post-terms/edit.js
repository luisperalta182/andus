...
import { AlignmentToolbar, InspectorAdvancedControls, BlockControls, Warning, useBlockProps } from '@wordpress/block-editor';
...
export default function PostTermsEdit({
  ...
  if (!hasPost) {
    return createElement("div", blockProps, createElement(Warning, null, __('Post Terms block: post not found.')));
  }
