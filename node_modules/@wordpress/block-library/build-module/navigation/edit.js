...
import { useState, useEffect, useMemo, useRef, Platform } from '@wordpress/element';
import { InnerBlocks, __experimentalUseInnerBlocksProps as useInnerBlocksProps, InspectorControls, JustifyToolbar, BlockControls, useBlockProps, store as blockEditorStore, withColors, PanelColorSettings, ContrastChecker, getColorClassName } from '@wordpress/block-editor';
...
const ALLOWED_BLOCKS = ['core/navigation-link', 'core/search', 'core/social-links', 'core/page-list', 'core/spacer', 'core/home-link'];
const LAYOUT = {
  type: 'default',
  alignments: []
};
...
function Navigation({
  ...
  const [isPlaceholderShown, setIsPlaceholderShown] = useState(!hasExistingNavItems);
  ...
  return createElement(Fragment, null, createElement(BlockControls, null, hasItemJustificationControls && createElement(JustifyToolbar, {
  ...
  }), createElement(ToolbarGroup, null, navigatorToolbarButton)), navigatorModal, createElement(InspectorControls, null, hasSubmenuIndicatorSetting && createElement(PanelBody, {
  ...
  })))), createElement("nav", blockProps, createElement(ResponsiveWrapper, {
    id: clientId,
...
export default compose([withSelect((select, {
  ...
  return {
    updateInnerBlocks(blocks) {
      ...
      dispatch(blockEditorStore).replaceInnerBlocks(clientId, blocks, true);
    }
