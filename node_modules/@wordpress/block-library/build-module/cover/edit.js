...
import { BaseControl, Button, FocalPointPicker, PanelBody, PanelRow, RangeControl, ResizableBox, Spinner, ToggleControl, withNotices, __experimentalUseCustomUnits as useCustomUnits, __experimentalBoxControl as BoxControl } from '@wordpress/components';
...
function CoverEdit({
  ...
  }, __('Clear Media')))), createElement(PanelBody, {
    title: __('Dimensions')
