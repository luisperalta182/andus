...
import { BlockCaption, MediaPlaceholder, MediaUpload, MediaUploadProgress, MEDIA_TYPE_IMAGE, BlockControls, InspectorControls, BlockAlignmentToolbar, BlockStyles, store as blockEditorStore } from '@wordpress/block-editor';
...
import { LINK_DESTINATION_CUSTOM, MEDIA_ID_NO_FEATURED_IMAGE_SET } from './constants';
...
export class ImageEdit extends Component {
  ...
  setMappedAttributes({
    ...
    return href === undefined ? setAttributes(restAttributes) : setAttributes({ ...restAttributes,
      href
    });
  }
  ...
  render() {
    ...
    }), this.getAltTextSettings()), createElement(PanelBody, {
      title: __('Link Settings')
    }, this.getLinkSettings(true)), createElement(PanelBody, {
