...
import { BlockControls, InspectorControls, InspectorAdvancedControls, RichText, __experimentalImageSizeControl as ImageSizeControl, __experimentalImageURLInputUI as ImageURLInputUI, MediaReplaceFlow, store as blockEditorStore, BlockAlignmentControl } from '@wordpress/block-editor';
...
export default function Image({
  ...
  const imageSizeOptions = map(filter(imageSizes, ({
    slug
