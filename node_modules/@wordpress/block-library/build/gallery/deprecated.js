...
const deprecated = [{
  ...
  migrate(attributes) {
    return { ...attributes,
      ids: (0, _lodash.map)(attributes.ids, id => {
  ...
  isEligible({
    ...
    return images && images.length > 0 && (!ids && images || ids && images && ids.length !== images.length || (0, _lodash.some)(images, (id, index) => {
  ...
  migrate(attributes) {
    return { ...attributes,
      ids: (0, _lodash.map)(attributes.images, ({
        id
      }) => {
        if (!id) {
          return null;
