...
const ColumnsEditContainerWrapper = (0, _data.withDispatch)((dispatch, ownProps, registry) => ({
  ...
  updateColumns(previousColumns, newColumns) {
    ...
    if (isAddingColumn && hasExplicitWidths) {
      ...
      innerBlocks = [...(0, _utils.getMappedColumnWidths)(innerBlocks, widths), ...(0, _lodash.times)(newColumns - previousColumns, () => {
      ...
      innerBlocks = [...innerBlocks, ...(0, _lodash.times)(newColumns - previousColumns, () => {
        return (0, _blocks.createBlock)('core/column', {
          verticalAlignment
        });
      })];
...
const ColumnsEdit = props => {
  ...
  (0, _element.useEffect)(() => {
    if (isSelected && isDefaultColumns) {
      (0, _lodash.delay)(() => setIsVisible(true), 100);
    }
  }, []);
