...
function NavigationLinkEdit({
  ...
  const {
    ...
    return {
      ...
      isTopLevelLink: getBlockParentsByBlockName(clientId, name).length === 0,
  ...
  }, [clientId]); // Store the colors from context as attributes for rendering

  (0, _element.useEffect)(() => setAttributes({
    isTopLevelLink
  }), [isTopLevelLink]);
  /**
  ...
  function insertLinkBlock() {
    ...
    const blockToInsert = (0, _blocks.createBlock)('core/navigation-link');
  ...
  const innerBlocksProps = (0, _blockEditor.__experimentalUseInnerBlocksProps)({
    className: (0, _classnames.default)('wp-block-navigation-link__container', {
  ...
  const classes = (0, _classnames.default)('wp-block-navigation-link__content', {
  ...
  return (0, _element.createElement)(_element.Fragment, null, (0, _element.createElement)(_blockEditor.BlockControls, null, (0, _element.createElement)(_components.ToolbarGroup, null, (0, _element.createElement)(_components.KeyboardShortcuts, {
    bindGlobal: true,
    shortcuts: {
      [_keycodes.rawShortcut.primary('k')]: () => setIsLinkOpen(true)
    }
  ...
  }), missingText) : (0, _element.createElement)(_blockEditor.RichText, {
    ref: ref,
    identifier: "label",
    ...
    onRemove: removeLink
  })), hasDescendants && showSubmenuIcon && (0, _element.createElement)("span", {
