...
const EmbedNoPreview = ({
  ...
  const comingSoonDescription = postType === 'page' ? (0, _i18n.__)('We’re working hard on adding support for embed previews. In the meantime, you can preview the embedded content on the page.') : (0, _i18n.__)('We’re working hard on adding support for embed previews. In the meantime, you can preview the embedded content on the post.');
  ...
  }, (0, _i18n.__)('Embed previews not yet available')), (0, _element.createElement)(_reactNative.Text, {
  ...
  }, (0, _i18n.__)('Embed block previews are coming soon')), (0, _element.createElement)(_reactNative.Text, {
