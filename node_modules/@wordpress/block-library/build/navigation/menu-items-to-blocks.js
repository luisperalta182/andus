...
function mapMenuItemsToBlocks(menuItems) {
  ...
  const sortedItems = (0, _lodash.sortBy)(menuItems, 'menu_order');
  const innerBlocks = sortedItems.map(menuItem => {
    ...
    const block = (0, _blocks.createBlock)('core/navigation-link', attributes, nestedBlocks); // Create mapping for menuItem -> block
