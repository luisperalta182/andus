...
var _imageEditing = _interopRequireWildcard(require("./image-editing"));
...
function Image({
  ...
  const imageSizeOptions = (0, _lodash.map)((0, _lodash.filter)(imageSizes, ({
    slug
  }) => (0, _lodash.get)(image, ['media_details', 'sizes', slug, 'source_url'])), ({
    name,
    slug
  }) => ({
    value: slug,
  ...
  if (canEditImage && isEditingImage) {
    img = (0, _element.createElement)(_imageEditing.default, {
      url: url,
      width: width,
      height: height,
  ...
  return (0, _element.createElement)(_imageEditing.ImageEditingProvider, {
    id: id,
    url: url,
    naturalWidth: naturalWidth,
    naturalHeight: naturalHeight,
